/**
 * Taken from https://github.com/odysseyscience/react-s3-uploader/s3upload.js
 * Changes:
 * - removed console.logs
 * - renamed onFinishS3Put to onFinish to match the prop name
 *
 */
...
S3Upload.prototype.onFinish = function(signResult, file) {}
